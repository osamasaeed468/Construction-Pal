...
import 'dashboard_wager.dart';
import 'wagers_profile.dart';

var anId;
var us;

class WagersMain extends StatefulWidget {
  const WagersMain({Key? key}) : super(key: key);

  @override
  _WagersMainState createState() => _WagersMainState();
}

class _WagersMainState extends State<WagersMain>
  ...
  Future<dynamic> getData() async {
    ...
    FirebaseFirestore.instance.collection("Wagers").doc(us);
  ...
  // if(variable!=null) {
  // name=variable.data()!['name'].toString()
  // }
          ...
          children: [
            ListTile(
              onTap: () async {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const DashboardWager()));
              },
            ...
            ListTile(
              onTap: () async {
                ...
                us = user!.uid;
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => WagersProfile()));
              },
    ...
    return Container(
      child: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection("Requests")
            .where('wagerID', isEqualTo: user!.uid)
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                Text(
                    'Are you sure you want to Delete or Complete the project?'),
              ],
            ),
          ),
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                var variable = await FirebaseFirestore.instance
                    ...
                    .doc(uid)
                    .get();
                String orders = variable.data()!['orders'].toString();
                String num = "1";
...
class OrderBoxx extends StatefulWidget {
  ...
  const OrderBoxx(
      {Key? key,
        ...
        required this.description,
        required this.address,
        required this.documentSnapshot, required this.projectID})
      : super(key: key);
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: () async{
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => CompleteWorkDetail(widget.projectID,widget.id)),
                  );
                ...
                child: Padding(
                    ...
                    child: Column(
                        children: <Widget>[
                          ...
                          //
                          //             color: Color(0xFFCD3424),
                          //             child: Text("Upload Project Pictures", style: TextStyle(
                          //               fontWeight: FontWeight.bold,
                          //               fontSize: 18,
                          //               color: Colors.white,
                          //             ),),
                          //             onPressed: (){
                          //               Navigator.push(context,  MaterialPageRoute(builder: (context) => AddImage(widget.projectID)),
                          //               );
                          //             },
                          //           )   )
                          //     ]
...
//addOrder(context, selectedDoc, name, price, time, cUid, sUid)
                                        ...
                                        FirebaseFirestore.instance
                                            .collection("Requests").doc("${widget.id}")
                                            .update({
