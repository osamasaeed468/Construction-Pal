...
class ShopOwnerProductDetailPage extends StatelessWidget {
  const ShopOwnerProductDetailPage({Key? key}) : super(key: key);

  static const routeName = '/shop-owner-product-detail-page';
